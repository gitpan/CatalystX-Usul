# @(#)$Id: Usul.pm 1164 2012-04-03 00:17:22Z pjf $
...
use version; our $VERSION = qv( sprintf '0.5.%d', q$Rev: 1164 $ =~ /\d+/gmsx );
...
This document describes CatalystX::Usul version 0.5.$Revision: 1164 $
