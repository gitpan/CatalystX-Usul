# @(#)$Id: Usul.pm 1150 2012-03-30 20:06:36Z pjf $
...
use version; our $VERSION = qv( sprintf '0.5.%d', q$Rev: 1150 $ =~ /\d+/gmsx );
...
This document describes CatalystX::Usul version 0.5.$Revision: 1150 $
