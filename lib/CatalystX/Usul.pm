# @(#)$Id: Usul.pm 1145 2012-03-30 07:21:31Z pjf $
...
use version; our $VERSION = qv( sprintf '0.5.%d', q$Rev: 1145 $ =~ /\d+/gmsx );
...
This document describes CatalystX::Usul version 0.5.$Revision: 1145 $
