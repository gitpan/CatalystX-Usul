# @(#)$Id: Usul.pm 1155 2012-04-01 12:12:40Z pjf $
...
use version; our $VERSION = qv( sprintf '0.5.%d', q$Rev: 1155 $ =~ /\d+/gmsx );
...
This document describes CatalystX::Usul version 0.5.$Revision: 1155 $
