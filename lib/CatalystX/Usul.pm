# @(#)$Id: Usul.pm 1139 2012-03-28 23:49:18Z pjf $
...
use version; our $VERSION = qv( sprintf '0.5.%d', q$Rev: 1139 $ =~ /\d+/gmsx );
...
This document describes CatalystX::Usul version 0.5.$Revision: 1139 $
