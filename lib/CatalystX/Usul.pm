# @(#)$Id: Usul.pm 1151 2012-03-31 12:58:44Z pjf $
...
use version; our $VERSION = qv( sprintf '0.5.%d', q$Rev: 1151 $ =~ /\d+/gmsx );
...
This document describes CatalystX::Usul version 0.5.$Revision: 1151 $
