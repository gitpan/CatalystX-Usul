# @(#)$Id: Usul.pm 1160 2012-04-02 11:32:32Z pjf $
...
use version; our $VERSION = qv( sprintf '0.5.%d', q$Rev: 1160 $ =~ /\d+/gmsx );
...
This document describes CatalystX::Usul version 0.5.$Revision: 1160 $
